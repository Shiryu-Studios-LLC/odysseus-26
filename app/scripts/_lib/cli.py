"""scripts/_lib/cli.py — shared scaffolding for the `shirabi-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("shirabi-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/shirabi-foo`
...
VERSION = "0.1.0"  # bumped centrally; every shirabi-* CLI reports this
